...
const Main = () => {
  return (
    <div className="relative">
      <img
        src={mainPhoto}
        className="w-full h-[470px] object-cover mt-6 rounded-2xl shadow-2xl"
      />

      <div className="absolute top-28 w-1/2 ml-24 flex flex-col">
        ...
        <button className="bg-gray-300 w-32 py-2 rounded-full mt-5">View Menu</button>
      </div>
    </div>
  );
};
